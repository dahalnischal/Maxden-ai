        ...
        <div className="project-flex-wraps">
          <div className="project-grided">
            ...
            <div className="images">
              <img src="assets/images/port-1.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-2.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-3.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-4.png" alt="" className="port-img" />
            </div>
          </div>
        </div>
