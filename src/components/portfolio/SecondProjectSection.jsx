        ...
        <div className="project-flex-wraps">
          <div className="project-grided">
            ...
            <div className="images">
              <img src="assets/images/port-5.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-6.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-7.png" alt="" className="port-img" />
            </div>
          </div>
          <div className="project-grided">
            <div className="project-wraps">
            ...
            <div className="images">
              <img src="assets/images/port-8.png" alt="" className="port-img" />
            </div>
          </div>
        </div>
